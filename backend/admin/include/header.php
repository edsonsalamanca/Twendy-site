<?php 
  ...
  $id_usuario = $_SESSION['user_logado'];
  ...
  $sobrenome_user = $dados['sobrenome'];
  $email_user = $dados['email'];
  $imagem_user = $dados['imagem'];
  $perfil_user = $dados['perfil'];
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
    <div class="container-scroller">
      ...
      <div class="horizontal-menu">
        <nav class="navbar top-navbar col-lg-12 col-12 p-0">
          <div class="container">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
              <a class="logo-mark" href="dashboard.php">
                <img src="logo/icon.png" alt="logo" />
               
              </a>
              
            </div>
            <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end mt-4">
                ...
                <li class="nav-item nav-profile dropdown">
                  <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                    <div class="nav-profile-img">
                      <img src="usuario/<?php echo $imagem_user; ?>" alt="image" />
                    </div>
                    <div class="nav-profile-text">
                      <p class="text-black font-weight-semibold m-0"> <?php echo $nome_user; ?> </p>
                      <span class="font-13 online-color">online <i class="mdi mdi-chevron-down"></i></span>
                    </div>
                  </a>
                  <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                    <a class="dropdown-item" href="meus-dados.php">
                      <i class="mdi mdi-cached mr-2 text-success"></i> Configurar </a>
                    <div class="dropdown-divider"></div>

                    
                      <a class="dropdown-item" href="alterar-senha.php">
        ...
        <nav class="bottom-navbar" id="bg-nav">
          <div class="container">
            <ul class="nav page-navigation">
              ...
              <li class="nav-item">
                <div class="nav-link d-flex">
                  <a href="projeto.php" class="btn btn-sm bg-danger text-white"> Criar Projeto</a>
                  <!--button class="btn btn-sm bg-danger text-white">  </button-->
